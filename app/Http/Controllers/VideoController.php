...
{
    public function create(VideoCreate $request)
    {
    ...
    public function load_subs(SubsLoad $request, int $video_id)
    {
    ...
    public function load_video(VideoLoad $request, int $video_id)
    {
        // $request->validated();
